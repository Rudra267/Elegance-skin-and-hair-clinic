!(function (e) {
      ...
      return this.each(function () {
        ...
        t.find("." + s.subMenuParent).each(function () {
          ...
          t.addClass(s.subMenuClass),
            t.css("display", "none"),
            e(this).addClass(s.subMenuParent),
            e(this).addClass(s.thSubMenuParent),
            e(this).children("a").append(s.appendElement);
        });
        ...
        e(o).each(function () {
          e(this).on("click", function (t) {
            ...
            t.preventDefault(),
              (a = e(this).parent()),
              (o = a.children("ul")).length > 0 &&
                (a.toggleClass(s.subMenuParentToggle),
                o.slideToggle(s.toggleSpeed),
                o.toggleClass(s.subMenuToggleClass));
          });
        }),
  ...
  i.on("init reInit afterChange", function (e, t, s, a) {
    ...
    i.on("beforeChange", function (e, t, s, a) {
      ...
      r.css("background-size", o + "% 100%").attr("aria-valuenow", o),
        c.text(o + "% completed");
    });
  ...
  i.on("init reInit afterChange", function (e, t, s, a) {
    ...
    e(".flip-gallery").length > 0 &&
      e(".flip-gallery").flipster({
        style: "carousel",
        spacing: -0.5,
        nav: !0,
        buttons: !0,
    ...
    (function () {
      ...
      a(
        ...
        e(g)
          .val()
          .match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/)
          ? (e(g).removeClass("is-invalid"), (s = !0))
          : (e(g).addClass("is-invalid"), (s = !1));
      return s;
    })() &&
      jQuery
        .ajax({ url: e(v).attr("action"), data: t, type: "POST" })
        .done(function (t) {
          m.removeClass("error"),
            m.addClass("success"),
            m.text(t),
            e(v + ' input:not([type="submit"]),' + v + " textarea").val("");
        })
        .fail(function (e) {
  ...
  e(v).on("submit", function (e) {
    ...
    w(".sidemenu-wrapper", ".sideMenuToggler", ".sideMenuCls", "show"),
    w(".shopping-cart", ".sideMenuToggler2", ".sideMenuCls", "show"),
    ...
    (e.fn.sectionPosition = function (t, s) {
      e(this).each(function () {
        ...
        (a = Math.floor(l.height() / 2)),
          (o = l.attr(t)),
          (n = l.attr(s)),
          (i = y(e(n).css("padding-top"))),
          (r = y(e(n).css("padding-bottom"))),
          "top-half" === o
  ...
  new WOW().init(),
    ...
    e(".testi-box-tab").length &&
      e(".testi-box-tab").asTab({ sliderTab: !0, tabButton: ".tab-btn" }),
    e(".testi-block-tab").length &&
      e(".testi-block-tab").asTab({ sliderTab: !0, tabButton: ".tab-btn" }),
    e(".hero-indicator").length &&
      e(".hero-indicator").asTab({
        sliderTab: !0,
        tabButton: ".indicatior-btn",
      }),
    e(".hero-indicator3").length &&
      e(".hero-indicator3").asTab({
        sliderTab: !0,
        tabButton: ".indicatior-btn",
      }),
    e(".hero-indicator.style2").length &&
      e(".hero-indicator.style2").asTab({
        sliderTab: !0,
        tabButton: ".indicatior-btn",
      }),
      ...
      e(this).each(function () {
        ...
        if (
          (a.on("click", function (t) {
            ...
            var a = e(this);
            a.addClass("active").siblings().removeClass("active"),
              s.sliderTab && e(o).slick("slickGoTo", a.data("slide-go-to"));
          }),
          s.sliderTab)
        ) {
          ...
          a.each(function () {
            ...
            a.attr("data-slide-go-to", n),
              ...
              e(o).on("beforeChange", function (e, a, o, n) {
    ...
    e(".th-custom-dots").length &&
      e(".th-custom-dots").vsTab({ sliderTab: !0, tabButton: ".dot-btn" }),
    ...
    e("#slider").on("input change", (t) => {
      ...
      e(".foreground-img").css("width", s + "%"),
        e(".slider-button").css("left", `calc(${s}% - 18px)`);
    }),
    ...
    (e.fn.indicator = function () {
      ...
      function i() {
        ...
        e(window).on("resize", function () {
          ...
          o.get(0).style.setProperty("--height-set", a),
          o.get(0).style.setProperty("--width-set", n),
          o.get(0).style.setProperty("--pos-y", i),
          o.get(0).style.setProperty("--pos-x", r);
      }
...
function fixGridHeight() {
  ...
  rows.forEach(row => {
    let grids = row.querySelectorAll('.service-box, .service-card, .service-grid, .service-item, .price-grid'); // target all service cards in the row
    let maxHeight = 0;

    // First, reset the heights and calculate the max height
    grids.forEach(grid => {
      grid.style.height = "auto"; // Reset height
      maxHeight = Math.max(maxHeight, grid.offsetHeight);
    });

    // Then, set the height of all the grids in the row to the maxHeight
    grids.forEach(grid => {
      grid.style.height = maxHeight + "px"; // Set max height for all cards in the row
    });
  });
}

// Trigger the function on page load and window resize
window.addEventListener("load", fixGridHeight);
